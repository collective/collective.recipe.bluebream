...
[1] Actually, it installs ``bin/paster``. And a small WSGI application. And some ZCML configuration files. And it creates var directories if they do not exist. And it supports develop eggs. ;-)
